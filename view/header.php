...
<link rel="stylesheet" href="assets/css/regfrm.css">
  ...
  <div id="header">
    ...
    <div id="navigation">
      <ul>
        ...
        <li><a href="harry_potter">HARRY POTTER</a></li>
        <li><a href="fast">FAST AND FURIOUS</a></li>
        <li><a href="#">CONTACT</a></li>
        <li><a href="registration">SingIn</a></li>
